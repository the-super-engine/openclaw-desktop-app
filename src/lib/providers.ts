...
/** All supported provider types with UI metadata - 中国区优先：Minimax 默认，DeepSeek 推荐 */
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  { id: 'minimax-portal-cn', name: 'MiniMax (默认)', icon: '☁️', placeholder: 'sk-...', model: 'MiniMax', requiresApiKey: false, isOAuth: true, supportsApiKey: true, defaultModelId: 'MiniMax-M2.5', apiKeyUrl: 'https://platform.minimaxi.com/' },
  { id: 'deepseek', name: 'DeepSeek (推荐)', icon: '🔷', placeholder: 'sk-...', model: 'DeepSeek', requiresApiKey: true, defaultBaseUrl: 'https://api.deepseek.com/v1', defaultModelId: 'deepseek-chat', apiKeyUrl: 'https://platform.deepseek.com/' },
  { id: 'siliconflow', name: 'SiliconFlow', icon: '🌊', placeholder: 'sk-...', model: 'DeepSeek 等', requiresApiKey: true, defaultBaseUrl: 'https://api.siliconflow.cn/v1', showModelId: true, showModelIdInDevModeOnly: true, modelIdPlaceholder: 'deepseek-ai/DeepSeek-V3', defaultModelId: 'deepseek-ai/DeepSeek-V3' },
  { id: 'minimax-portal', name: 'MiniMax (国际)', icon: '☁️', placeholder: 'sk-...', model: 'MiniMax', requiresApiKey: false, isOAuth: true, supportsApiKey: true, defaultModelId: 'MiniMax-M2.5', apiKeyUrl: 'https://intl.minimaxi.com/' },
  ...
  { id: 'moonshot', name: 'Moonshot (Kimi)', icon: '🌙', placeholder: 'sk-...', model: 'Kimi', requiresApiKey: true, defaultBaseUrl: 'https://api.moonshot.cn/v1', defaultModelId: 'kimi-k2.5' },
